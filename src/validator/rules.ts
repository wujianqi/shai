 ...
 * 自定义方法集合
 */
export const customRule: { [key: string]: ValidFunction } = {};
...
export const rules = {
    ...
    len: (arg1: string | number | any[], arg2: string | number) => {
        const v1 = typeof arg1 === 'number' ? String(arg1) : arg1,
            v2 = typeof arg2 === 'string' ? +arg2 : arg2;

        return v1.length === v2;
    },
    minlen: (arg1: string | number | any[], arg2: string | number) => {
        const v1 = typeof arg1 === 'number' ? String(arg1) : arg1,
            v2 = typeof arg2 === 'string' ? +arg2 : arg2;

        return v1.length >= v2;
    },
    maxlen: (arg1: string | number | any[], arg2: string | number) => {
        const v1 = typeof arg1 === 'number' ? String(arg1) : arg1,
            v2 = typeof arg2 === 'string' ? +arg2 : arg2;
    ...
    in: <T extends string | number | any[] | object>(
        ...
        if ((typeof arg1 === 'number' || typeof arg1 === 'string') &&
            ...
            return String(arg2).indexOf(String(arg1)) > -1;
    ...
    custom: (arg: any, key: string | ValidFunction, ...args: any[]) => {
